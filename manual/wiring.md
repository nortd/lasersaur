...
[Index](index) -- [DriveBoard](driveboard) | Wiring Guide

The electronics subsystem consists of the [DriveBoard](driveboard) and its sensing and control peripherials: **laser** system, **gantry** steppers, **limit** switches, **door** switches, **chiller**. Additonally it implements a reliable **stop** mechanism.
...
<img src="img/wiring-lasersaur-control.jpg" style="width:100%">
