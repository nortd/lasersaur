...
### Belt Resistance
The v14.03 system is quite tolerant about belt tension. Still the belts can be over-tensioned. Basically when the tension reaches level that causes shafts, idlers, and pulleys to bend you may introduce unecesary friction into the system. On the other side of the spectrum, belts can be too loose. When super loose belts start jumping on the pully. Still slighly loose belts  can cause inprecision of the cuts (This inprecision is below a 1mm).
